...
viewof canvasHeight = Inputs.range([width/2, 2*width], {value: width/2, step: 5, label: "Height/Number of Generations"});
...
p5(s => {
    ...
    s.setup = function() {
        s.createCanvas(width, canvasHeight);
        s.background(255);
